...
public partial class @PlayerInputs : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Scroll"",
                    ""type"": ""PassThrough"",
                    ""id"": ""4a7d80b1-c91f-4e4c-b34e-18b356a756bd"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""7d25f7c2-6932-4079-9431-f153965a899e"",
                    ""path"": ""<Mouse>/scroll"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Magic Crafting"",
                    ""type"": ""Button"",
                    ""id"": ""a62a5c83-94a2-444d-857c-eb5149d695c0"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""bda17075-4377-4184-860a-32f340a226cc"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""FPS Toggle"",
                    ""type"": ""Button"",
                    ""id"": ""53e73ce8-ae01-4139-b393-290e0498976b"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                },
                {
                    ...
                    ""processors"": """",
                    ""groups"": ""KBM"",
                    ""action"": ""Magic Crafting"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""43832fbb-8fd3-41ba-80fe-612c0b9cb3c1"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1e910e62-e6c1-4b15-9961-130013aa6d23"",
                    ""path"": ""<Keyboard>/f1"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""KBM"",
        ...
        {
            ""name"": ""Gameplay"",
            ""id"": ""db5d8611-806f-4a35-bc67-a7d7e14c83a8"",
            ""actions"": [
                {
                    ""name"": ""Interact"",
                    ""type"": ""Button"",
                    ""id"": ""76d5bd65-a6a8-447c-aeaf-91760a524daa"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Alt Interact"",
                    ""type"": ""Button"",
                    ""id"": ""8c06ff15-3e98-418a-a552-3747c165a17a"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""019edda5-1dc0-4d79-9eb6-47934b7b3048"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""KBM"",
                ...
                {
                    ""name"": """",
                    ""id"": ""4371075a-a4c0-483b-9107-fa2346085678"",
    ...
    ""controlSchemes"": [
        ...
        m_Mouse_LeftMouse = m_Mouse.FindAction("Left Mouse", throwIfNotFound: true);
        m_Mouse_RightMouse = m_Mouse.FindAction("Right Mouse", throwIfNotFound: true);
        m_Mouse_Scroll = m_Mouse.FindAction("Scroll", throwIfNotFound: true);
        // UI
        m_UI = asset.FindActionMap("UI", throwIfNotFound: true);
        m_UI_Inventory = m_UI.FindAction("Inventory", throwIfNotFound: true);
        m_UI_MagicCrafting = m_UI.FindAction("Magic Crafting", throwIfNotFound: true);
        m_UI_Pause = m_UI.FindAction("Pause", throwIfNotFound: true);
        m_UI_FPSToggle = m_UI.FindAction("FPS Toggle", throwIfNotFound: true);
        // Gameplay
        m_Gameplay = asset.FindActionMap("Gameplay", throwIfNotFound: true);
        m_Gameplay_Interact = m_Gameplay.FindAction("Interact", throwIfNotFound: true);
        m_Gameplay_AltInteract = m_Gameplay.FindAction("Alt Interact", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_UI_MagicCrafting;
    private readonly InputAction m_UI_Pause;
    private readonly InputAction m_UI_FPSToggle;
    public struct UIActions
    {
        private @PlayerInputs m_Wrapper;
        public UIActions(@PlayerInputs wrapper) { m_Wrapper = wrapper; }
        public InputAction @Inventory => m_Wrapper.m_UI_Inventory;
        public InputAction @MagicCrafting => m_Wrapper.m_UI_MagicCrafting;
        public InputAction @Pause => m_Wrapper.m_UI_Pause;
        public InputAction @FPSToggle => m_Wrapper.m_UI_FPSToggle;
        ...
        public void SetCallbacks(IUIActions instance)
        {
            if (m_Wrapper.m_UIActionsCallbackInterface != null)
            {
                ...
                @MagicCrafting.started -= m_Wrapper.m_UIActionsCallbackInterface.OnMagicCrafting;
                @MagicCrafting.performed -= m_Wrapper.m_UIActionsCallbackInterface.OnMagicCrafting;
                @MagicCrafting.canceled -= m_Wrapper.m_UIActionsCallbackInterface.OnMagicCrafting;
                @Pause.started -= m_Wrapper.m_UIActionsCallbackInterface.OnPause;
                @Pause.performed -= m_Wrapper.m_UIActionsCallbackInterface.OnPause;
                @Pause.canceled -= m_Wrapper.m_UIActionsCallbackInterface.OnPause;
                @FPSToggle.started -= m_Wrapper.m_UIActionsCallbackInterface.OnFPSToggle;
                @FPSToggle.performed -= m_Wrapper.m_UIActionsCallbackInterface.OnFPSToggle;
                @FPSToggle.canceled -= m_Wrapper.m_UIActionsCallbackInterface.OnFPSToggle;
            }
            ...
            if (instance != null)
            {
                ...
                @MagicCrafting.started += instance.OnMagicCrafting;
                @MagicCrafting.performed += instance.OnMagicCrafting;
                @MagicCrafting.canceled += instance.OnMagicCrafting;
    ...
    public struct GameplayActions
    {
        ...
        public void SetCallbacks(IGameplayActions instance)
        {
            if (m_Wrapper.m_GameplayActionsCallbackInterface != null)
            {
                ...
                @AltInteract.started -= m_Wrapper.m_GameplayActionsCallbackInterface.OnAltInteract;
                @AltInteract.performed -= m_Wrapper.m_GameplayActionsCallbackInterface.OnAltInteract;
                @AltInteract.canceled -= m_Wrapper.m_GameplayActionsCallbackInterface.OnAltInteract;
            }
    ...
    public interface IUIActions
    {
        ...
        void OnMagicCrafting(InputAction.CallbackContext context);
